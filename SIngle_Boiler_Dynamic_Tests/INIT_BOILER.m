...
g        = 9.81;
b        = 0.030e0;    % Empirical coefficient in q_4d (dimensionless)
tau_s    = 1e-2;       % Steam residence time in drum [s]

% Metal masses (dominant in pressure dynamics)
m_metal = 1*(1e6);     % Total boiler metal mass [kg]
...
files = { ...
    'Feedwater_drum_pressure.csv', ...
    'Feedwater_Flow_Input_Step.csv', ...
    'Feedwater_Water_level_deviation.csv', ...
    'Fuel_Flow_Dynamic_Step_Input.csv', ...
    'Fuel_flow_Input_Steam_drum_pressure.csv', ...
    'Fuel_flow_Input_Water_level_deviation.csv', ...
    'Steam_test_drum_pressure.csv', ...
    'Steam_test_Water_level_deviation.csv',...
        'Steam_Flow_Input_Step.csv' };
