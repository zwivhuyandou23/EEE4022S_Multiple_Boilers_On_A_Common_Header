...
p1_MPa = 8.8;   q_s1 = 41;%35.17;   % Boiler 1 drum pressure & flow
p2_MPa = 8.7;   q_s2 = 34.2;%25.54;   % Boiler 2 drum pressure & flow
...
%% ---------------------- Run Simulink -------------------------------------
simStopTime = '5000'; % or based on input signal length
