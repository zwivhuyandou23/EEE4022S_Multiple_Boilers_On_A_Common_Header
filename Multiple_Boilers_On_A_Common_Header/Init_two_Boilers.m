...
clc;
%% ---------------------- Display Boiler 1 data ----------------------------
disp('=== Boiler 1: States (x0_1) ===');
fprintf('Vwt   = %.3f m^3\n', x0_1(1));
fprintf('p     = %.3f MPa\n', x0_1(2));
fprintf('a3    = %.5f [-]\n', x0_1(3));
fprintf('Vsd   = %.3f m^3\n', x0_1(4));

disp('--- Boiler 1: Inputs (u0_1) ---');
fprintf('Q     = %.3f MW\n', u0_1(1));
fprintf('qf    = %.3f kg/s\n', u0_1(2));
fprintf('q4    = %.3f kg/s\n', u0_1(3));
fprintf('hf    = %.2f kJ/kg\n', u0_1(4));

disp('--- Boiler 1: Parameters ---');
fprintf('rho_w = %.2f kg/m^3\n', rho_w1);
fprintf('rho_s = %.2f kg/m^3\n', rho_s1);
fprintf('h_w   = %.2f kJ/kg\n', h_w1);
fprintf('h_s   = %.2f kJ/kg\n', h_s1);
fprintf('h_lat = %.2f kJ/kg\n', h_lat1);
fprintf('alpha_r = %.5f [-]\n', alpha_r1);
fprintf('Loop friction k1 = %.6e\n', k1);

disp('--- Boiler 1: Construction/Geometry ---');
fprintf('Vr=%.2f, Vd=%.2f, Vdc=%.2f, Ad=%.2f, Adc=%.2f\n', Vr,Vd,Vdc,Ad,Adc);

%% ---------------------- Display Boiler 2 data ----------------------------
disp('=== Boiler 2: States (x0_2) ===');
fprintf('Vwt   = %.3f m^3\n', x0_2(1));
fprintf('p     = %.3f MPa\n', x0_2(2));
fprintf('a3    = %.5f [-]\n', x0_2(3));
fprintf('Vsd   = %.3f m^3\n', x0_2(4));

disp('--- Boiler 2: Inputs (u0_2) ---');
fprintf('Q     = %.3f MW\n', u0_2(1));
fprintf('qf    = %.3f kg/s\n', u0_2(2));
fprintf('q4    = %.3f kg/s\n', u0_2(3));
fprintf('hf    = %.2f kJ/kg\n', u0_2(4));

disp('--- Boiler 2: Parameters ---');
fprintf('rho_w = %.2f kg/m^3\n', rho_w2);
fprintf('rho_s = %.2f kg/m^3\n', rho_s2);
fprintf('h_w   = %.2f kJ/kg\n', h_w2);
fprintf('h_s   = %.2f kJ/kg\n', h_s2);
fprintf('h_lat = %.2f kJ/kg\n', h_lat2);
fprintf('alpha_r = %.5f [-]\n', alpha_r2);
fprintf('Loop friction k2 = %.6e\n', k2);

disp('--- Boiler 2: Construction/Geometry ---');
fprintf('Vr=%.2f, Vd=%.2f, Vdc=%.2f, Ad=%.2f, Adc=%.2f\n', Vr,Vd,Vdc,Ad,Adc);